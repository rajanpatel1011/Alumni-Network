...
<body>
	<form action="Login" class="loginForm" method="post">
		<table width="100%">
			<tr>
				<td><label class="label-name">Username :</label></td>
				<td><input type="text" id="inputUname" name="uid"
			...
			<tr>
				<td><label class="label-name">Password :</label></td>
				<td><input type="password" id="inputPWD" name="pwd"
					placeholder="Password"> <input type="hidden" name="check"
					value="1">
					<div id="emptyPwd" class="bubble">
						<span style="color: #FFF">*This field is required.</span>
					</div> <!-- div class="val-require">*This field is required.</div> --></td>
			</tr>
			<tr>
				<td colspan="2">
					<%
					...
					<div id="internalError" class="bubble">
						<span style="color: #FFF">*Internal server Error.Please Try
							Again.</span>
						<%
							}
					...
					%>
						...
						<center>
							<input type="submit" id="signin" class="btn" value="Login">
						</center>
				</td>
			</tr>
		</table>
