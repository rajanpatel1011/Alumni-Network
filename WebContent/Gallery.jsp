...
#forum, #myprofile, #searchmem, #privmsg, #makeapp, #reportuser,
	#mod_req, #user_req {
...
{ %>
	...
	$(document).ready(function(e) {
		$('#createalbm').show();
						...
						<table style="margin-top: 35px; margin-left: 40px;">
							<tr>
								<th bgcolor="#FFFF99"><font color="red"> <% 	if(resultFlag.equals("1"))
	{
...
%>
					...
					<div
						...
						<form enctype="multipart/form-data" name="form1" method="post"
							action="GalleryAlbumUploadSERVLET">
							<h5 style="color: #000; font-weight: normal; display: inline">
								&nbspAlbum Name&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; <input
							...
							<h5 style="color: #000; font-weight: normal">
								&nbspAlbum picture&nbsp;:&nbsp;&nbsp; <input type="file"
									value="Open" name="imageFile">

								<h5 style="color: #000; font-weight: normal; display: inline;">&nbsp;Taken
									date &nbsp;:</h5>
								<input type="date" id="date" name="date" style="left: 10px">

								<br />
								<h5 style="color: #000; font-weight: normal; display: inline;">&nbspCaption
									&nbsp;:&nbsp;&nbsp;</h5>
								<input type="text" name="caption"> <br />
								<h5 style="color: #000; font-weight: normal; display: inline;">&nbsp
									Details &nbsp;:&nbsp;&nbsp;</h5>
								<textarea rows="4" cols="4" name="details"></textarea>

								<br /> <input type="Submit" value="Save" name="submit"
									id="post-save" style="margin-left:"0px">
							</h5>
	...
	GalleryAlbumUploadBO BO=new GalleryAlbumUploadBO();
		...
		List<GalleryAlbumUploadBEAN> list=BO.view(p_id,b_id);
         ...
         {         
         %>
						<li class="box" align="right"><span id="dialogoutput"></span>

							<a href="DeleteAlbumSERVLET?value=<%=bean.getA_id()%>"
							id="dialoglink"> <i class="icon-remove"> </i>
						</a> <%
        }
         else
         { %>
						<li class="box" align="right">
							...
							<div class="tm_view tm_view_first">
								<a href="PhotoDisplaySERVLET?param=<%=bean.getA_id()%>"> <img
									src=<%=bean.getUpload_pic()%>
									...
									<div class="tm_content">
										...
										<p>
											<%=bean.getPermissionName() %><br /> Created by:
											<%=bean.getF_name()%><br />
											<%=bean.getCaption()%>
											<br /><%=bean.getDate_time()%><br />
										</p>
										<p></p></a>
							</div>
				</div>
