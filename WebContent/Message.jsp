...
#forum, #myprofile, #searchmem, #gallery, #makeapp, #reportuser,
	#mod_req, #user_req {
	...
	$("#newpost-content1").show();
				...
				<div class="newpost-content" id="newpost-content1">
					...
					<div style="float: left; width: 80%;" class="newpost-content2">
						...
						<h4 style="margin-left: 40px; margin-right: 10px; display: inline">User
							:</h4>
						<input type="text" name="f1" class="foruminput"
							style="margin-left: 29px; margin-right: 10px; width: 70%;"
							placeholder="Enter name of the user" onChange="fetchUsers()">
						<br />
						<h4 style="margin-left: 40px; margin-right: 10px; display: inline">Message
							:</h4>
						<textarea name="f2" class="forumtextarea" rows="2"
							style="margin-right: 21px; width: 70%;"
					...
					<div style="float: left; margin-top: 40px;"
						...
						<button id="post-btn" type="submit" name="button" id="button"
							value="Submit" onclick="return val(form1)">Send</button>
					</div>

					<div style="margin-top: 225px;">
						<button class="newpost-btn" id="newpost-btn1">New Message
						</button>
					</div>
				</div>
			</form>
			...
			<div class="forum" id="i-fourm">
				<form class="form-search">
					<span style="font-size: 16px; font-weight: bold;">Search :</span> <input
						type="text"
						style="width: 70%; font-size: 14px; height: 25px; margin: 20px; margin-left: 40px; margin-right: 40px;"
