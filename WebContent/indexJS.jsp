	...
	<div class="content">
		...
		<div class="photoslide">
			<div style="color: #FFF;">
				<center>
					<h4 style="color: #FFF;">
						Javascript disabled Click <a href="Noscript.jsp">here</a> for
						instruction.
						</h2>
				</center>
			</div>
		...
		int R = r.nextInt(High-Low) + Low; %>
				<img src="images/pic<%=R%>.png" width="65%" alt=""
			...
			<div class="block-slogan"
				...
				<center>
					...
					<div style="color: #707070; text-align: left">
						<p>
							XYZ Collage is a vibrant community of scholarship and learning
							that stands in the nation's service and in the service <br /> of
							all nations.
						</p>
					</div>
				</center>
