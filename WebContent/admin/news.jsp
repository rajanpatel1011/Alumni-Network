...
$('#news-btn').addClass('click-btn-css');
	...
	<div class="news" id="news">
		<label class="tab-title">Archive News</label><br /> <a
			href="admin/createNews.jsp"><button class="crtbtn" id="crnews">Create
				News</button></a>
		<div class="prvnews">
			<table>
				<tr class="colname">
				...
				<form name='newsupdate' action='NewsUpdateSERVLET' method='post'>
					<tr>
						...
						<td><img src="/ff" alt="X" /></td>
						<td><%= bean.getDate_time().getDate() +"-"+bean.getDate_time().getDay()+"-"+bean.getDate_time().getYear() %>
						</td>
					</tr>
