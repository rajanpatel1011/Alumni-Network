...
<body>
	...
	<div class="content">
       ...
       {%>
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">You already
						reported this Student!</font></th>
			</tr>
		</table>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="#11DA00">Student is
						Reported...</font></th>
			</tr>
		</table>
		...
		<% } if(resultFlag.equals("3")){
    	 %><table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Try again!</font></th>
			</tr>
		</table>
		<%
     }
		...
		<div class="main"
			...
			<form name="profile-action" action="ReportstudentSERVLET?id=<%=id%>"
				method="post">
        ...
        %>
							...
							<div>
								<label class=label id=issmse style="float: right;">Issus
									Massage:</label><input type=text class="edit" name="msg"></input>
