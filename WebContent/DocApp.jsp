...
;
#forum, #myprofile, #searchmem, #gallery, #privmsg, #reportuser,
	#mod_req, #user_req {
...
<link rel="stylesheet" href="css/DocRequest.css" type="text/css"
	media="screen">
<style>
.content {
	margin-top: 240px;
			...
			<table align="center">
				<tr>
					<th bgcolor="#211C19"><font color="red">Fill Subject
							And Description Comulsory</font></th>
				</tr>
			</table>
			<%
				}
			...
			<table width="100%" height="100%" cellspacing="15" class="center"
				...
				<tr>
					...
					<td><input type="text" name="subject" id="subject"
						style="width: 800px;" placeholder="Subject of the application"></td>
				</tr>

				<tr>
					<td>Description :</td>
					<td><textarea rows="5" name="description" id="subject"
							cols="1000" style="width: 800px"
							placeholder="Desription of the application"></textarea></td>
				</tr>
				<tr>
					<td colspan="2">
						<center>
