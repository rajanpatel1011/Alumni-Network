...
<body>
	...
	<div class="content">
       ...
       {%><table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Unchecked!!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Other
						hobbies !</font></th>
			</tr>
		</table>
		<%}%>
    	...
    	%><table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter First
						Name!</font></th>
			</tr>
		</table>
		...
		<% } if(resultFlag.equals("6")){
    	 %><table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Middle
						Name!</font></th>
			</tr>
		</table>
     ...
     {%><table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Last Name!</font>
				</th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Select Gender!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Mobile
						Number!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Email
						Address!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Address
						Line one!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Select Degree!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Highest
						Education college Name!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Course
						Name!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter
						PassoutYear !</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter The Other
						Institude Name!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Job Year!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Joy Month!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Key
						Skills!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Internal Error!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">File Not Found!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Image must be
						jpg or jpeg or png file only!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter the Job
						Type!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<table align="center">
			<tr>
				<th bgcolor="#211C19"><font color="red">Enter Industry
						Name!</font></th>
			</tr>
		</table>
		<%} %>
		...
		<div class="main"
			...
			<form name="profile-action" id=fom action="UpdateProfileSERVLET"
            ...
            %>
							...
							</h1> <a href="profileSERVLET"> <input type="button" name="back"
								class="btn" id="back" value="Back" /></a>
						</td>
					</tr>
					<tr>
                ...
                %>
										<td><span class="tm_image_reflection"><img
												src="<%=picpath %>" width="160" height="200" /></span><br />
										<input type="file" value="pic" name="profilepic"></td>
										<td>
											<table width="100%">
												<tr>
												...
												<tr id=temp>
													...
													<td>
														<button class="btn" type="button" id="edit_btn">Change
															Password</button>
												...
												<tr class="edit">
													...
													<td><input type="password" id=npwd name="oldpwd" />
												...
												<tr class="edit">
													<td><b> <label class="label"> Confirm
																Password :</label>
													</b></td>
													<td><input type="password" id=cpwd name="newpwd" />
       ...
       {  
 							if(resultFlag1.equals("100")){
								...
								out.println("<tr><td id=passwordnotmatch colspan='2'><font color=red>Password not match</font></td></tr>");
									...
									<tr>
										...
										<td>
											<%if(lname.equals(null)){ %><input
											style="display: inline; width: 100px;" type="text"
											name="lname" />
											<%}else{ %> <input style="display: inline; width: 100px;"
											type="text" id=lname value="<%=lname%>" name="lname" />
											<%} %> <%if(fname.equals(null)){ %><input
											style="display: inline; width: 100px;" type="text"
											name="fname" />
											<%}else{ %> <input style="display: inline; width: 100px;"
											type="text" id=fname value="<%=fname %>" name="fname" />
											<%} %> <%if(mname.equals(null)){ %><input type="text"
											style="display: inline; width: 100px;" name="mname" />
											<%}else{ %> <input type="text"
											style="display: inline; width: 100px;" id=mname
											value="<%=mname%>" name="mname" />
											<%} %>
											...
											<div id="emptymname" class="bubble">
												<span style="color: red;"> *Middle name is required </span>
											</div>
											...
											<div id="emptyfname" class="bubble">
												<span style="color: red;"> *First nam is required. </span>
											</div>
           ...
           { %> <input type="radio" name="gender" id="Male" value="Male"
											checked /> <%
             }else{ %> <span> Male </span> <input type="radio"
											name="gender" id="Male" value="Male" /> <span>Female</span>
											<%} %> <%if(gen.equals("f"))
            	 {%> <input type="radio" name="gender" id="Female"
											value="Female" checked /> <%
             }else{ %> <span> Male </span> <input type="radio"
											name="gender" id="Female" value="Female" /> <span>Female</span>
											<%} %>
										</td>
									</tr>
									<tr>
										<td><b> <label class="label">Date Of Birth :</label>
												<td><input type="date" name="dob" id="txtDate"
													value="<%=dat%>" /></td>
									</tr>
									<tr>
										...
										<td><input type="text" id="mobno" value="<%= mobileno%>"
											...
											<div id="nomobno" class="bubble">
												<span style="color: red;"> *Mobile number must be in
													number digit. </span>
											</div>
											<div id="digitmobno" class="bubble">
												<span style="color: red;"> *Mobile number must be is
													only 10 digit. </span>
											</div></td>
									</tr>
									<tr>
										...
										<td><input type="text" value="<%=email%>" id=email
											...
											<div id="properemail" class="bubble">
												<span style="color: red;"> *Email must be in proper
													format. </span>
											</div></td>
									</tr>
									<tr>
           ...
           if(hbean==null){
        	   ...
        	   for(MemhobbiesBEAN allhobbies:allOfHobbiesrequest){
        		   ...
        		   %> <input type="checkbox" name="hobbiesnameid<%=j%>"
											value="<%=hId%>"><%=name %></input> <% j++;
        	  ...
        	  int j=1;
        	   for(MemhobbiesBEAN allhobbies:allOfHobbiesrequest){
        		   ...
        		   String name=allhobbies.getHobbieesname();
        		   %> <input type="checkbox" name="hobbiesnameid<%=j%>"
											value="<%=hId%>" <%if(hbean.contains(allhobbies)){ %>
											checked="checked" <%}%>><%=name %></input> <% j++;
   				%> <input type="hidden" name="hobbiesallid" value="<%=name%>" />
											<% }
        	   }   %>
										</td>
									...
									<tr>
										<td></td>
										<td><input type="checkbox" name="checkotherhobbies"
											id=ock checked="checked" /> <label>Others : </label> <%if(otherhobbies.equals(null)){ %><input
											type="text" name="others_hobbies"></input>
											<%}else{ %> <input type="text" id=hob name="others_hobbies"
											value="<%=otherhobbies %>" />
											<%} %>
									...
									<tr>
										<td height="226"><b> <label class="label">Address
													:</label>
										</b> <br />
										<br />
										<br />
										...
										<td><hr />
											<table>
												<tr>
													...
													<td>
														<%if(add1.equals(null)){ %><textarea rows="2" cols="3"
															name="add1"></textarea>
														<%}else{ %> <textarea rows="2" cols="5" name="add1" id=add1><%=add1%></textarea>
														<%} %>
														<div id="emptyadd1" class="bubble">
															<span style="color: red;"> *Address line is
																required. </span>
														</div>
													</td>
												</tr>
												<tr>
													...
													<td>
														<%if(add2.equals(null)){ %><textarea rows="2" cols="3"
															name="add2"></textarea>
														<%}else{ %> <textarea rows="2" cols="5" name="add2" id=add2><%=add2%></textarea>
														<%} %>
 ...
 %>
	          ...
	          %>
														<option value=<%=alldegreeId %>><%=alldegree%>
														</option>
														<%
  	 	 	 	}
  	         }
  %>
														<option selected="selected"
															value="<%=educationdegegreeId%>"><%=educationdegree%></option>
												</select> <%-- <input type="text"   value="B.E/B.Tech" />  --%></td>
											</tr>
											<tr>
												<td><b><label class="label">Branch :</label></b></td>
												<td>
													<%--all branchs  --%> <input type="text"
													value="<%=educationbranch%>" disabled /> <%-- 	<input type="text"   value="I.T" /> --%>
												</td>
											</tr>
											<tr>
												<td><b><label class="label">Passout Year :</label></b>
												</td>
												<td><input type="hidden" name="educationId"
													value="<%=educationId%>"></input> <input type="text"
													value="<%=educationpassoutyear%>" disabled /></td>
											</tr>
											<tr>
												<td><b><label class="label">College/Institute
															:</label></b></td>
												<td><input type="text" name="colname" id=highclg
													value="<%=educationclgname %> " />
													<div id="emptyhighclg" class="bubble">
														<span style="color: red;"> *College name is
															required. </span>
													</div></td>
											</tr>
										</table>
		  ...
		  %>
										<table width="100%">
											<tr>
												<td><b><label class="label">Degree :</label></b></td>
												<td><input type="hidden" name="othereducationId"
													value="<%=othereducationId%>"></input> <input type="text"
													name="certi_cource" value="<%=othereducationdegree%>"
													disabled /></td>
											</tr>
											<tr>
												<td><b><label class="label">Branch(cource
															Name) :</label></b></td>
												<td><input type="text" name=branch_name id=ocource
													value="<%=othereducationcourse %>" />
													<div id="emptycource" class="bubble">
														<span style="color: red;"> *Cource name is
															required. </span>
													</div></td>
											</tr>
											<tr>
												...
												<td><input type="text" name=pas_year id=oyear
													value="<%=othereducationpassoutyear %>" />
													<div id="emptyoyear" class="bubble">
														<span style="color: red;"> *Year is required. </span>
													</div>
													<div id="nooyear" class="bubble">
														<span style="color: red;"> *Year must be in Number
															form. </span>
													</div></td>
											</tr>
											<tr>
												<td><b><label class="label">College/Institute
															:</label></b></td>
												<td><input type="text" name=col_name id=oclg
													value="<%=othereducationclgname %>" />
								...
								<tr>
									...
									<td>
										<%if(totexpyear.equals(null)){%><input type="text" name=jyear
										style="width: 50px;" />
										<%}else{ %> <input type="text" name=jyear style="width: 50px;"
										id=jyear value="<%=totexpyear %>" />
										<%} %> <%if(totexpmont.equals(null)){ %><input type="text"
										name=jmonth style="width: 50px;" />
										<%}else{ %> <input type="text" name=jmonth style="width: 50px;"
										id=jmonth value="<%=totexpmont %>" />
										<%} %>
								...
								<tr>
									...
									<td>
										<%if(keyskills.equals(null)){ %><input type="text"
										name=key_skill />
										<%}else{ %> <input type="text" name=key_skill id=keys
										value="<%=keyskills %>" />
										<%} %>
										<div id="emptykeys" class="bubble">
											<span style="color: red;"> *Key Skill is required. </span>
										</div>
									</td>
								</tr>
								<tr>
       	...
       	%> <input type="hidden" name="profeId<%=i%>" value="<%=profe%>" />
										...
										<table width="100%">
											<tr>
												...
												<td><input type="text" name="job_type<%=i%>" id=jobtype
													value="<%=jobtype %>" />
											...
											<tr>
												...
												<td><select name="job_st_mon<%=i %>">
														...
														<option>Nov</option>
														<option>Dec</option>
														<option selected="selected"><%=startmonth %></option>
												</select> <select name="job_st_yer<%=i %>">
														<option>2012</option>
														<option>2011</option>
														<option>2010</option>
														<option>2009</option>
											...
											<tr>
												...
												<td><select name="job_ed_month<%=i%>">
														...
														<option>Nov</option>
														<option>Dec</option>
														<option selected="selected"><%=endmonth %></option>
												</select> <select name="job_ed_yer<%=i %>">
														<option>2012</option>
														<option>2011</option>
														<option>2010</option>
														<option>2009</option>
											...
											<tr>
												...
												<td><input type="text" name="industry_name<%=i %>"
													id=indu value="<%=industryname %>" />
													<div id="emptyindu" class="bubble">
														<span style="color: red;"> *Industry name is
															required. </span>
													</div></td>
											</tr>
											<tr>
												...
												<td><input type="text" name="f_area<%=i %>" id=farea
													value="<%=functionarea %>" />
													<div id="emptyfarea" class="bubble">
														<span style="color: red;"> *Funcation area is
															required. </span>
													</div></td>
											</tr>
										</table> <%  i++;
								...
								<tr>
									...
									<td width="83"><a href="AddJobInProfile" id="1"><button
										...
										<%if(resultFlag2.equals("notadd")){ %> <label>Not added
											...
											not delete </label> <%} %> <a
										href="DeleteJobBlockSERVLET?del=<%=resultFlag2%>"><button
												type="button" id="edit_btn" class="btn">Delete Job</button></a>
										<%}%></td>
								</tr>
							</table>
						</td>
