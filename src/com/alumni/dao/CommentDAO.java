	...
	public void AddComments(String addcomment, String f_Id, int cr_id) throws SQLException {
		...
		try {
			...
			PreparedStatement ps = con
					.prepareStatement("insert into comment(f_Id,cmt_data,m_Id,date_time) values(?,?,?,now());");
			...
			PreparedStatement ps1 = con.prepareStatement(
					"update forum set No_Of_cmt = (select count(c_Id) as noCmt from comment where f_Id=forum.f_Id) where f_Id=forum.f_Id;");
			ps1.executeUpdate();
