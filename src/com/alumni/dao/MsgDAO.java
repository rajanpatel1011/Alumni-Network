...
public class MsgDAO {
...

	{
		...
		try {
			...
			String s = "select forum.creator_id,members.f_name,members.l_name,forum.desription,forum.date_time from forum, members where (forum.creator_id=members.m_id) and (forum.reciver_id=?);";
