		...
		try {
			...
			if (optionSelected.equals("1")) {
				ps1 = con.prepareStatement(
						"select m.m_Id,m.u_Id,m.f_name,m.l_name,m.profile_pic,b.Branch_Name as b_Name,p.Passout_yr as p_Name from members m,branch b,passout_year p where m.b_Id=b.b_Id and m.p_Id=p.p_Id and f_name Like '"
								+ searchText + "%' and m.m_Id<>?");
				ps1.setInt(1, loginId);
			} else if (optionSelected.equals("2")) {
				ps1 = con.prepareStatement(
						"select m.m_Id,m.u_Id,m.f_name,m.l_name,m.profile_pic,b.Branch_Name as b_Name,p.Passout_yr as p_Name from members m,branch b,passout_year p where m.b_Id=b.b_Id and m.p_Id=p.p_Id and f_name Like '"
								+ searchText + "%' and m.p_Id=? and m.b_Id=? and m.m_Id<>?");
				ps1.setInt(1, p_Id);
				ps1.setInt(2, b_Id);
				...
				ps1 = con.prepareStatement(
						"select m.m_Id,m.u_Id,m.f_name,m.l_name,m.profile_pic,b.Branch_Name as b_Name,p.Passout_yr as p_Name from members m,branch b,passout_year p where m.b_Id=b.b_Id and m.p_Id=p.p_Id and f_name Like '"
								+ searchText + "%' and m.p_Id=? and m.m_Id<>?");
				ps1.setInt(1, p_Id);
				ps1.setInt(2, loginId);
			} else if (optionSelected.equals("4")) {
				ps1 = con.prepareStatement(
						"select m.m_Id,m.u_Id,m.f_name,m.l_name,m.profile_pic,b.Branch_Name as b_Name,p.Passout_yr as p_Name from members m,branch b,passout_year p where m.b_Id=b.b_Id and m.p_Id=p.p_Id and f_name Like '"
								+ searchText + "%' and m.b_Id=? and m.m_Id<>?");
				ps1.setInt(1, b_Id);
				ps1.setInt(2, loginId);
			}
