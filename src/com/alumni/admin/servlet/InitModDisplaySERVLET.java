			...
			try {
				...
				if (list == null)
					...
					response.getWriter().write(
							"<table width='100%' style='margin-left:0px;'><tr><th>No.</th><th>First Name</th><th>Last Name</th><th>Branch</th><th>Year</th><th>Become moderator</th></tr><tr><td colspan='6'><hr/></td></tr>");
					for (InitModBEAN bean : list) {
						...
						response.getWriter()
								.write("<tr><td>" + n + "</td><td>" + fname + "</td><td>" + lname + "</td><td>" + beanch
										+ "</td><td>" + year + "</td><td><a href='../BecomemInitModSERVLET?flag=" + mid
										+ "'><button type='button'>Become Moderator</button></a></td></tr>");
						n++;
					}
